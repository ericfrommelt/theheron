...
(function($, win) {
    ...
    $.fn.sudoSlider = function(optionsOrg) {
        ...
        var defaults = {
			...
			controlsfade:      FALSE, /*  option[5]/*controlsfade*/
			...
			autoheight:        FALSE, /*  option[28]/*autoheight*/
            autowidth:         FALSE, /*  option[29]/*autowidth*/
			...
			prevhtml:          '<a href="#" class="prevBtn hide-text"> previous </a>', /* option[34]/*prevhtml*/
			nexthtml:          '<a href="#" class="nextBtn hide-text"> next </a>', /* option[35]/*nexthtml*/
